    ...
    <div class="accordion m-3" id="accordionItems">
        ...
        <div id="accorAdaptador" class="accordion-collapse collapse" aria-labelledby="accorAdaptador-head" data-bs-parent="#accordionItems">
            <div class="accordion-body listItemByItem">
                ...
                <a class="list-group-item d-flex align-items-start list-group-item-action">

                    <h6 data-bs-toggle="modal" data-bs-target="#editarArt">00000000000001</h6>
                    <h6 data-bs-toggle="modal" data-bs-target="#editarArt">Marca-item</h6>
                    <h6 data-bs-toggle="modal" data-bs-target="#editarArt">Modelo-item</h6>
                ...
                <a class="list-group-item d-flex align-items-start list-group-item-action">
                    <h6 data-bs-toggle="modal" data-bs-target="#editarArt">00000000000002</h6>
                    <h6 data-bs-toggle="modal" data-bs-target="#editarArt">Marca-item</h6>
                    <h6 data-bs-toggle="modal" data-bs-target="#editarArt">Modelo-item</h6>
                    <div class="form-check form-switch">
