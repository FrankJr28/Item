...
<div class="container-fluid">
    <div class="row abs-center">
        <div class="col-push-12">
            <button class="btn btn-dark b-round" data-bs-toggle="modal" data-bs-target="#login-modal">    Iniciar Sesión
            </button><br><br>
            
            <a href="#" class="btn btn-primary b-round" style="text-decoration: none" id="btnLoginGoogle"><i class="bi bi-google"></i> Continuar con Google</a>
